...
=== "Odkaz"
    ...
    [Vytvořit projekt]( vscode://cubicap.jaculus/import?uri=https://2026.robotickytabor.cz/moduly/fotorezistor/fotorezistor-example.tar.gz){.md-button .md-button--primary}
=== "Command line"
