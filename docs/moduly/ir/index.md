...
=== "Odkaz"
    ...
    [Create project]( vscode://cubicap.jaculus/import?uri=https://2026.robotickytabor.cz/moduly/ir/ir-example.tar.gz){.md-button .md-button--primary}
=== "VSCode extension"
    ...
    `https://2026.robotickytabor.cz/moduly/ir/ir-example.tar.gz`.
=== "Command line"
...
=== "Zip"
    ...
    [Zip soubor](https://2026.robotickytabor.cz/moduly/ir/ir-example.zip){.md-button .md-button--primary}
